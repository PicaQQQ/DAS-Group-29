...
data.new$Marital_Status <- as.factor(ifelse(data.new$Marital_Status %in% c("Married-spouse-absent", "Separated", "Widowed","Never-married"), "Other", as.character(data.new$Marital_Status)))

data.new$Occupation <- as.factor(ifelse(data.new$Occupation %in% c("Craft-repair","Exec-managerial", "Handlers-cleaners", "Machine-op-inspct", "Priv-house-serv", "Protective-serv", "Sales", "Transport-moving"), "Other", as.character(data.new$Occupation)))
