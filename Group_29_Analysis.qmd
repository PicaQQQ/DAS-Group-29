...
\begin{align*}
\ln\left(\frac{p}{1 - p}\right)=&\widehat{\alpha}+\widehat{\beta}_{\text{Age}}\cdot\text{Age}+\sum_{i=1}^{14}\widehat{\beta}_{\text{Education,i}}\cdot\mathbb{I}_{\text{Education,i}}(x)\\
&+\sum_{i=1}^{12}\widehat{\beta}_{\text{Occupation,i}}\cdot\mathbb{I}_{\text{Occupation,i}}(x)+\sum_{i=1}^{5}\widehat{\beta}_{\text{Marital-Status,i}}\cdot\mathbb{I}_{\text{Marital-Status,i}}(x)\\
&+\sum_{i=1}^{31}\widehat{\beta}_{\text{Nationality,i}}\cdot\mathbb{I}_{\text{Nationality,i}}(x)+\widehat{\beta}_{\text{Male}}\cdot\mathbb{I}_{\text{Male}}(x)+\widehat{\beta}_{\text{Hour-PW}}\cdot\text{Hours-PW}
\end{align*}
...
\ln\left(\frac{p}{1 - p}\right)=&\widehat{\alpha}+\widehat{\beta}_{\text{Age}}\cdot\text{Age}+\sum_{i=1}^{14}\widehat{\beta}_{\text{Education,i}}\cdot\mathbb{I}_{\text{Education,i}}(x)\\
&+\sum_{i=1}^{12}\widehat{\beta}_{\text{Occupation,i}}\cdot\mathbb{I}_{\text{Occupation,i}}(x)+\sum_{i=1}^{5}\widehat{\beta}_{\text{Marital-Status,i}}\cdot\mathbb{I}_{\text{Marital-Status,i}}(x)\\
&+\widehat{\beta}_{\text{Hours-PW}}\cdot\text{Hours-PW}
\end{align*}
...
\begin{align*}
\ln\left(\frac{p}{1 - p}\right)=&\widehat{\alpha}+\widehat{\beta}_{\text{Age}}\cdot\text{Age}+\widehat{\beta}_{\text{Low-Education}}\cdot\mathbb{I}_{\text{Low-Education}}(x)\\
&+\widehat{\beta}_{\text{Physical-Labor}}\cdot\mathbb{I}_{\text{Physical-Labor}}(x)+\widehat{\beta}_{\text{Unmarried}}\cdot\mathbb{I}_{\text{Unmarried}}(x)\\
&+\widehat{\beta}_{\text{Male}}\cdot\mathbb{I}_{\text{Male}}(x)+\widehat{\beta}_{\text{Hours-PW}}\cdot\text{Hours-PW}
\end{align*}
...
\begin{align*}
\ln\left(\frac{p}{1 - p}\right)=&\widehat{\alpha}+\widehat{\beta}_{\text{Age}}\cdot\text{Age}+\widehat{\beta}_{\text{Low-Education}}\cdot\mathbb{I}_{\text{Low-Education}}(x)\\
&+\sum_{i=1}^{6}\widehat{\beta}_{\text{Occupation,i}}\cdot\mathbb{I}_{\text{Occupation,i}}(x)+\widehat{\beta}_{\text{Unmarried}}\cdot\mathbb{I}_{\text{Unmarried}}(x)\\
&+\widehat{\beta}_{\text{Male}}\cdot\mathbb{I}_{\text{Male}}(x)+\widehat{\beta}_{\text{Hours-PW}}\cdot\text{Hours-PW}
\end{align*}
...
\begin{align*}
    \ln\left(\frac{p}{1 - p}\right)=&\widehat{\alpha}+\widehat{\beta}_{\text{Age}}\cdot\text{Age}+\widehat{\beta}_{\text{Low-Education}}\cdot\mathbb{I}_{\text{Low-Education}}(x)\\
    &+\sum_{i=1}^{9}\widehat{\beta}_{\text{Occupation,i}}\cdot\mathbb{I}_{\text{Occupation,i}}(x)+\widehat{\beta}_{\text{Unmarried}}\cdot\mathbb{I}_{\text{Unmarried}}(x)\\
    &+\widehat{\beta}_{\text{Male}}\cdot\mathbb{I}_{\text{Male}}(x)+\widehat{\beta}_{\text{Hours-PW}}\cdot\text{Hours-PW}
\end{align*}
...
The stepwise AIC model selection process was applied separately to datasets using different occupational classification methods (Mental vs. Physical Labor, PRC Job Classification, and ISCO-08). All models showed improvement in fitting compared to the full model, **but the best performance was observed with the PRC Job Classification.** Nationality was removed in the AIC-selected models, reinforcing the earlier observation that nationality has little impact on income prediction.

Key Takeaways:

-   PRC Job Classification provides a structured way to assess income distribution across occupations.

-   Category 1 (Senior Management) and Category 2 (Specialists & Technical Support) dominate the high-income group, while other categories are more likely to fall into lower income levels by comparison.

The final model based on the PRC Job Classification achieved the lowest AIC value, making it a robust choice for workforce and economic analysis.
...
\begin{align*}
    \ln\left(\frac{p}{1 - p}\right)=&\widehat{\alpha}+\widehat{\beta}_{\text{Age}}\cdot\text{Age}+\widehat{\beta}_{\text{Low-Education}}\cdot\mathbb{I}_{\text{Low-Education}}(x)\\
    &+\widehat{\beta}_{\text{Physical-Labor}}\cdot\mathbb{I}_{\text{Physical-Labor}}(x)+\widehat{\beta}_{\text{Unmarried}}\cdot\mathbb{I}_{\text{Unmarried}}(x)\\&+\widehat{\beta}_{\text{Male}}\cdot\mathbb{I}_{\text{Male}}(x)+\widehat{\beta}_{\text{Hours-PW}}\cdot\text{Hours-PW}\\
    &+\widehat{\beta}_{\text{Unmarrid,Age}}\cdot\text{Age}\cdot\mathbb{I}_{\text{Unmarried}}(x)+\widehat{\beta}_{\text{Unmarrid,Male}}\cdot\mathbb{I}_{\text{Male}}\cdot\mathbb{I}_{\text{Unmarried}}(x)
\end{align*}
...
\begin{align*}
    ...
    &+\sum_{i=1}^{6}\widehat{\beta}_{\text{Occupation,i}}\cdot\mathbb{I}_{\text{Occupation,i}}(x)+\widehat{\beta}_{\text{Unmarried}}\cdot\mathbb{I}_{\text{Unmarried}}(x)\\
    &+\widehat{\beta}_{\text{Male}}\cdot\mathbb{I}_{\text{Male}}(x)+\widehat{\beta}_{\text{Hours-PW}}\cdot\text{Hours-PW}\\
    &+\widehat{\beta}_{\text{Male,Unmarried}}\cdot\mathbb{I}_{\text{Male}}\cdot\mathbb{I}_{\text{Unmarried}}(x)+\sum_{i=1}^{6}\widehat{\beta}_{\text{Male,Occupationi}}\cdot\mathbb{I}_{\text{Male}}\cdot\mathbb{I}_{\text{Occupation,i}}(x)
\end{align*}
...
\begin{align*}
    \ln\left(\frac{p}{1 - p}\right)=&\widehat{\alpha}+\widehat{\beta}_{\mbox{Age}}\cdot\mbox{Age}+\widehat{\beta}_{\mbox{Low-Education}}\cdot\mathbb{I}_{\mbox{Low-Education}}(x)\\
    &+\sum_{i=1}^{9}\widehat{\beta}_{\mbox{Occupation,i}}\cdot\mathbb{I}_{\mbox{Occupation,i}}(x)+\widehat{\beta}_{\mbox{Unmarried}}\cdot\mathbb{I}_{\mbox{Unmarried}}(x)\\
    &+\widehat{\beta}_{\mbox{Male}}\cdot\mathbb{I}_{\mbox{Male}}(x)+\widehat{\beta}_{\mbox{Hours-PW}}\cdot\mbox{Hours-PW}\\
    &+\sum_{i=1}^{9}\widehat{\beta}_{\mbox{Unmarried,Occupationi}}\cdot\mathbb{I}_{\mbox{Unmarried}}\cdot\mathbb{I}_{\mbox{Occupation,i}}(x)
\end{align*}
