...
The AIC of `model_new.2.interaction` is the smallest, indicating the best model fit. Additionally, `model_new.2.interaction` achieves the highest AUC of 0.872, demonstrating the strongest ability to classify high-income (\>50K) and low-income (\<=50K) groups.
